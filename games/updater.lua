local aliveCheck = function(player)
	if player ~= lplr then 
		if player.leaderstats.Bed.Value ~= '✅' and player.Character.Humanoid and player.Character:WaitForChild('Humanoid').Health == 0 then return false else return nil end
	end
